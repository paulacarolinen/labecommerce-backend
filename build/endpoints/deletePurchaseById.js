...
exports.deletePurchaseById = void 0;
const knex_1 = require("../database/knex");
const deletePurchaseById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const idToDelete = req.params.id;
        const [purchaseIdExist] = yield (0, knex_1.db)("purchases").where({ id: idToDelete });
        if (!purchaseIdExist) {
            res.status(404);
...
//# sourceMappingURL=deletePurchaseById.js.map